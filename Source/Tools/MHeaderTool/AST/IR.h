...
// spec §2.3: 记录类型分类
enum class ERecordKind : uint8_t
{
    Class,
    Struct
};
...
enum class EFunctionTransport : uint8_t
{
    None,
    ServerCall,
    ClientCall,
...
enum class EAwaitSiteKind : uint8_t
{
    AwaitOkMacro,
    TAwaitableCall,
    AwaitableBare
