...
TVariant MakeVarInt(int64 V) { return TVariant::MakeInt(V); }
TVariant MakeVarStr(const char* S) { return TVariant::MakeString(MString(S)); }
} // namespace
...
{
    SetupEnv(
        "Monster = {}; Monster.__index = Monster\n"
