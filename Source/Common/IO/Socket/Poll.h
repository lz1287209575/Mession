...
class MSocketPoller {
    public:
    template <typename TConnectionMap, typename TGetConnection> static TVector<SSocketPollItem> BuildReadableItems(TConnectionMap& Connections, TGetConnection GetConnection) {
