...
M_WORLD_PLAYER_PROXY_ROUTE(PlayerMove, FPlayerMoveRequest, FPlayerMoveResponse, Controller, "PlayerMove")
...
M_WORLD_PLAYER_PROXY_ROUTE(PlayerQueryPawn, FPlayerQueryPawnRequest, FPlayerQueryPawnResponse, Pawn, "PlayerQueryPawn")
